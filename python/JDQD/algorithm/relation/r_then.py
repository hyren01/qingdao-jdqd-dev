...
def rule103(sentence, sub_sentences):
    # 匹配模式: ...首先...然后...
    return pattern.rule_skscks(sentence, sub_sentences, keywords, parts, comma=False)
...
def rule301(sentence, sub_sentences):
    # 匹配模式: ..., ...然后...
    return pattern.rule_scsks(sentence, sub_sentences, keywords, parts)


def rule302(sentence, sub_sentences):
    # 匹配模式: ..., 然后...
    return pattern.rule_scks(sentence, sub_sentences, keywords, parts)
