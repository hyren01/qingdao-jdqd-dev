...
def rule202(sentence, sub_sentences):
    # 匹配模式: ..., 而且...
    return pattern.rule_scks(sentence, sub_sentences, keywords_also, period=False)
...
def rule301(sentence, sub_sentences):
    ...
    return pattern.rule_scks(sentence, sub_sentences, keywords, reverse=True, period=False)
