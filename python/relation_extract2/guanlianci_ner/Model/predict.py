...
config_path = './resc/chinese_L-12_H-768_A-12/bert_config.json'
checkpoint_path = './resc/chinese_L-12_H-768_A-12/bert_model.ckpt'
dict_path = './resc/chinese_L-12_H-768_A-12/vocab.txt'
label_path = './resc/Parameter/tag_dict.txt'
...
def extract_items(model, sentence):
