...
class Config(object):
    ...
    def __init__(self):
        ...
        # 训练后模型保存路径
        self.trained_model_dir = "event_extract/train/model/event_state_trained_model"
        # 训练后模型名称
        self.trained_model_name = "state_bert4keras_v03_model.h5"
        # 训练集数据保存路径
        self.all_data_path = "event_extract/train/resources/event_state_data/state_all_data.json"
        # 训练后测试集预测结果
        self.pred_path = 'event_extract/train/resources/event_state_data/test_pred.json'
        # 训练批次大小
        self.batch_size = 8
        # 循环
        self.epoch = 100
