...
try:
    ...
    cur.execute("SELECT * FROM t_article_msg_en where substring(article_id,1,1) ='9' and article_id not in ( select distinct article_id from  t_article_msg_zh) and content <>''")
    rs = cur.fetchall()
